...
- Libby's 20 May 2026 wording updates changed "DJ hire and dancefloors/dance floors" to **"DJ hire"** across website gallery labels and print prompt/profile sources. Libby's 8 June 2026 follow-up changed the print DJ service description to **"bringing my event background"**.
...
- Gmail review on 8 June 2026 found the Alex-specific Libby requests in emails dated 20 May, 24 May, 1 June, and 8 June 2026: brochure + business cards should use **"DJ hire"** only; DJ copy should say **"bringing my event background"**; the slogan should be **"Ceremonies with personality, warmth and a fresh approach"** everywhere; the booking line should remove the comma in **"preferred dates if you have them and the county or venue area"**. A separate 1 June email titled **"susan Stevens last minor changes"** mentions a wrong business-card phone number, wedding photo diversity replacement, and business-card tooth-gap photo issue; do not apply those to Alex Real without confirming the client.
- 8 June 2026 website copy cleanup removed comma-before-`and`/`or` wording across live `src` copy and `index.html` metadata, including homepage, services, process, contact placeholder, FAQ, terms, 404, and footer attribution. Preserve ordinary separating commas such as **"Ceremonies with personality, warmth and a fresh approach"** unless Libby explicitly asks to remove those too.
...
- 16 June 2026 final brochure direction: the corrected Alex brochure is now the quality benchmark for future celebrant collateral. Related skills were updated to treat it as an aesthetic high-water mark for polish, density, panel balance, layered backgrounds, strong cover/back/contact design, and premium print feel. For other clients, adapt that standard of craft to their own brand, copy, photos, logo, palette, and tone; do not clone Alex's identity.
